...
export default class Connection {
        ...
        if (this.currentCommand.label === 'help') {
            ...
            for (let line of msg.split(/\n/)) {
                ...
                const params = this.registeredHooks[event]
                    ...
                    : parseParams(line, SHOULD_PARSE_PARAMS[this.currentCommand.label]);

                if (VALID_HOOKS[event]) {
                    this.recievedEvent(params, event, line);
                }
                if (this.currentCommand.options.expectData === false || event !== "error") {
    ...
    clearCommandQueue() {
        this.commandQueue[0].splice(0, this.commandQueue.length);
    }
